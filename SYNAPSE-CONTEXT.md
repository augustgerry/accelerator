...
- **Langkah Berikutnya Jika Terputus:** Sub-task 1 & 2 SELESAI (lihat bawah). Lanjut sub-task 3 (PPTX template-following, gap paling besar) atau sub-task 4 (tag .pptx di Template Library).
