...
export const SKELETONS: Record<DraftDocTypeId, SkeletonSection[]> = {
  ...
  klarifikasi_teknis: [
    { id: "sec-klarifikasi-latar-belakang", title: "1. Latar Belakang & Ringkasan Hasil Aanwijzing", category: "Umum", description: "Latar belakang sesi aanwijzing / klarifikasi teknis, daftar dokumen acuan, dan rangkuman poin-poin kesepakatan utama antara SMG dan Panitia Pengadaan." },
    { id: "sec-klarifikasi-matrix", title: "2. Matriks Pertanyaan, Klarifikasi & Tanggapan Solusi SMG", category: "Teknis", description: "Tabel perbandingan klausul TOR vs Hasil Klarifikasi dan Solusi SMG (Aspek Ketentuan, Tanggapan / Penjelasan Teknis SMG, Rekomendasi Arsitektur, Status Pemenuhan)." },
    { id: "sec-klarifikasi-arsitektur", title: "3. Penyesuaian Arsitektur Solusi & Sizing Hardware", category: "Teknis", description: "Penjelasan adaptasi arsitektur berdasarkan hasil klarifikasi, perhitungan kapasitas data growth, sizing CPU/RAM/Storage, konektivitas interface jaringan, dan redundansi." },
    { id: "sec-klarifikasi-boq", title: "4. Bill of Quantity (BOQ) & Lisensi Perangkat", category: "Teknis", description: "Tabel rincian komponen perangkat keras (Server, Storage, Switch, Kabel DAC/Optik) dan software/lisensi lengkap dengan Part Number, Deskripsi, dan Kuantitas." },
    { id: "sec-klarifikasi-sla-tim", title: "5. Tim Tenaga Ahli, Timeline Pengerjaan & Komitmen SLA", category: "SLA & Support", description: "Susunan tim project manager dan engineer tersertifikasi SMG, jadwal tahapan implementasi, dan komitmen respons penanganan gangguan 24x7." },
  ],
  pitch_deck: [
